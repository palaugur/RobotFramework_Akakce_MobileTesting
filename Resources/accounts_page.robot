...
${login_register_button}            id=register_btn
...
${register_accept_and_conditions}   id=privacyCheck
...
Click On Register Button on Login Page
  Wait Until Page Contains Element  ${login_register_button}
...
Accept Terms And Conditions
  Scroll To Element    ${register_accept_and_conditions}
  Click Element        ${register_accept_and_conditions}
